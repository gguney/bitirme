...
<INPUT name="Button2"  TYPE="button" onclick="location.href='searchCountry.php';" VALUE="Search Country" class="formButton2">
...
<?php
	...
	$strSQL = "SELECT IID,IName as Institution_Name,CoName as Country FROM bil496.institutions as ins,bil496.countries as co where ins.ICountryID=co.CoID and co.CoName LIKE '".$field."%' ORDER BY ".$order." ".$orderType." limit ".$offset.", ".$limit.";";					
