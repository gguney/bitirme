...
<?php
	...
	CiName as City,
	CoName as Countyr,
	ins.TCount as Total_Count 
from bil496.institutions as ins,bil496.cities as ci,bil496.countries as co
where ins.ICityID = ci.CiID and ins.ICountryID = co.CoID ORDER BY ".$order." ".$orderType." limit ".$offset.", ".$limit.";";					
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="topInstitutions.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
