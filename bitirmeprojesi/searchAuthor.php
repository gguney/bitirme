...
<div class="scrollbar" id="real" style="background-image:url(images/authorIcon.png);background-size:70% 100%;background-position:350px;background-repeat:no-repeat;">
...
<tr>
<td>
 <label class="formLabel">Author Name</label>
</td>
<td>

	<input name="query" autocomplete="off"  class='formInput' type='txt' id='search_input' onKeyUp='javascript:getSearchSuggestion(event, this.value,"author");' /> 
    	<input name="limit" autocomplete="off"  class='formInput' type='txt' id='search_input' value="50" style="display:none"/> 

</td>
<td>

<button class="formButton" onclick="searcha()"> Search </button>
...
function searcha()
{
		...
		var order ="TCount";
		var orderType = "ASC"
		window.location.href="searchAuthor2.php?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
