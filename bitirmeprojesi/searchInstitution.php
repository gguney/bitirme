...
?>
<div class="scrollbar" id="real" style="background-image:url(images/institutionIcon.png);background-size:70% 100%;background-position:350px;background-repeat:no-repeat;">
...
<td>
	...
	<input name="query" autocomplete="off"  class='formInput' type='txt' id='search_input' onKeyUp='javascript:getSearchSuggestion(event, this.value,"institution");' style="width:500px;"/> 
    	<input name="limit" autocomplete="off"  class='formInput' type='txt' id='search_input' value="50" style="display:none;"/> 

</td>
<td>

<button class="formButton" onclick="searchi()"> Search </button>
