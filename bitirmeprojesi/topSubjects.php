...
<INPUT name="Button2"  TYPE="button" onclick="location.href='topSubjects2.php?*0+50*sub.TCount*ASC';" VALUE="Switch" class="formButton2">
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="topSubjects.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
