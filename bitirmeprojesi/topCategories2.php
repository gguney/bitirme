...
<INPUT name="Button2"  TYPE="button" onclick="location.href='topCategories.php?*0+50*cat.TCount*DESC';" VALUE="Switch" class="formButton2">
		...
		if($columnsDone == 0) //Column Names Printing 
		{
			...
			echo "<tr>";
				...
				{		
						...
						{
						echo "<td><span id='round' class='description'><a class='link' href='searchCategory2.php?".$row[$i]."*0+50*TCount*ASC'>".$row[$i]."</a></span></td>";			
						}
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="topCategories2.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
