...
?>
<div class="scrollbar" id="real" style="background-image:url(images/subjectIcon.png);background-size:70% 100%;background-position:350px;background-repeat:no-repeat;">
