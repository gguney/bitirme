...
<?php
	...
	au.AUID as AuthorID,
	 AUName as Author_Name,
	  ...
	  ins.IID as Institution_ID, 
	  ins.IName as Institution_Name,
	   AUFullAddress as Author_Full_Address ,
	   au.TCount as Total_Count 
	   from bil496.authors as au, bil496.subjects as s,bil496.aas as aas, bil496.institutions as ins, bil496.real as re where re.ArticleID = AID and au.AUAddressID = ins.IID and aas.AUID = au.AUID and aas.SID = s.SID and au.AUName LIKE '".$field."%' ORDER BY au.".$order." ".$orderType." limit ".$offset.", ".$limit.";";					
