<?php
	...
	if ($info == "author")
	{	
	$sql = "SELECT AUName FROM bil496.authors WHERE AUName LIKE '".$termin."%' limit 1000";
	$columnName = "AUName";
	...
	while($row = mysql_fetch_assoc($res)){
		echo "<label class='suggestboxLi' onclick='javascript:putSuggestion(this);'>".$row[$columnName]."</label></br>";
	}
?>