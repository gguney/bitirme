...
<INPUT name="Button2"  TYPE="button" onclick="location.href='searchCity.php';" VALUE="Search City" class="formButton2">
...
<?php
	...
	$strSQL = "SELECT IID,IName as Institution_Name,CiName as City FROM bil496.institutions as ins,bil496.cities as ci where ci.CiName LIKE '".$field."%' and ins.ICityID=ci.CiID ORDER BY ".$order." ".$orderType." limit ".$offset.", ".$limit.";";					
