...
<INPUT name="Button2"  TYPE="button" onclick="location.href='topCategories2.php?*0+50*cat.TCount*ASC';" VALUE="Switch" class="formButton2">
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="topCategories.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
