...
<INPUT name="Button2"  TYPE="button" onclick="location.href='searchSubject.php';" VALUE="Search Subject" class="formButton2">
<INPUT name="Button2"  TYPE="button" onclick="location.href='topSubjects.php?*0+50*sub.TCount*DESC';" VALUE="Switch" class="formButton2">
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="topSubjects2.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
