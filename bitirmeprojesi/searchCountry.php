...
?>
<div class="scrollbar" id="real" style="background-image:url(images/countryIcon.png);background-size:70% 100%;background-position:300px;background-repeat:no-repeat;">
...
<tr>
<td>
 <label class="formLabel">Country Name</label>
</td>
<td>

	<input name="query" autocomplete="off"  class='formInput' type='txt' id='search_input' onKeyUp='javascript:getSearchSuggestion(event, this.value,"country");'/> 
    	<input name="limit" autocomplete="off"  class='formInput' type='txt' id='search_input' value="50" style="display:none;"/> 

</td>
<td>

<button class="formButton" onclick="searchco()"> Search </button>
...
function searchco()
{
		...
		var order ="IName";
		var orderType = "ASC"
		window.location.href="searchCountry2.php?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
