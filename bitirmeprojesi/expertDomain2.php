...
<?php
	...
	ins.IID as InstitutionID,
	IName as Institution_Name,
	COUNT(IName) AS Total_Count
    FROM bil496.institutions as ins,bil496.subjects as sub,bil496.ais as ais
	where ins.IID = ais.IID and ais.SID = sub.SID and sub.SName='".$field."' 
    GROUP BY IName
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="expertDomain2.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
