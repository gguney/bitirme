...
<INPUT name="Button2"  TYPE="button" onclick="location.href='searchInstitution.php';" VALUE="Search Institution" class="formButton2">
</div>
<?php 
...
<?php
	...
	$strSQL = "Select IID,IName as Institution_Name,CiName as City,CoName as Country,ins.TCount as Total_Count from bil496.institutions as ins,bil496.cities as ci,bil496.countries as co where ins.ICityID = ci.CiID and ins.ICountryID= co.CoID and IName LIKE '".$field."%' ORDER BY ".$order." ".$orderType." limit ".$offset.", ".$limit.";";					
...
function decrease()
{
	...
	var orderType = "<?php echo $orderType; ?>";
 	offset = offset - limit;
		...
		window.location.href="searchInstitution2.php"+"?"+field+"*"+offset+"+"+limit+"*"+order+"*"+orderType;
